import re
import torch  # torch is still used for tensor types in MLX-LM
from datasets import load_dataset, Dataset
from transformers import AutoTokenizer  # Not using AutoModelForCausalLM anymore
from peft import LoraConfig
from trl import GRPOConfig, GRPOTrainer
from mlx_lm import load as mlx_load, generate as mlx_generate  # Use MLX-LM functions exclusively
...
# Load the model and tokenizer using MLX-LM exclusively.
# Set device to "metal" for Apple Silicon.
...
trainer = GRPOTrainer(
    ...
    #peft_config=peft_config  # Uncomment if you wish to use PEFT/LoRA fine-tuning
)
